...
const en = {
  ...
  statusGrounded: 'Source-grounded',
  statusGroundedNote: 'Traced to the printed source edition through the evidence below.',
  statusLegacy: 'Project commentary',
  statusLegacyNote: 'Authored from project commentary before source grounding existed; not extracted from Rāmakaṇṭha.',
  sourceTermsTitle: 'Source terms',
  relationshipsTitle: 'Relationships',
  termAttested: 'attested',
  termNormalised: 'normalised',
  termTranslated: 'translated',
  termInferred: 'inferred',
  relSynonymousWith: 'is synonymous with',
  relVariantOf: 'is a variant of',
  relBroaderThan: 'is broader than',
  relNarrowerThan: 'is narrower than',
  relPresupposes: 'presupposes',
  relContrastsWith: 'contrasts with',
  relExplains: 'explains',
  relQualifiedBy: 'is qualified by',
  relLeadsTo: 'leads to',
  relInseparableFrom: 'is inseparable from',
  relDistinguishedFrom: 'is distinguished from',
  relIdentifiedWith: 'is identified with',
  threadOrientation: 'Orientation',
  threadScholarly: 'Scholarly',
  threadTypeConcept: 'Concept',
  threadTypeArgument: 'Argument',
  threadTypeCrossVerse: 'Cross-verse',
  threadTypeChapter: 'Chapter',
  threadTypeDoctrinal: 'Doctrinal',
  threadTypeRecensional: 'Recensional',
  roleQuestion: 'Question',
  rolePremise: 'Premise',
  roleObjection: 'Objection',
  roleResponse: 'Response',
  roleDistinction: 'Distinction',
  roleDefinition: 'Definition',
  roleExample: 'Example',
  roleInference: 'Inference',
  roleConsequence: 'Consequence',
  roleConclusion: 'Conclusion',
  roleContext: 'Context',
  roleUnresolved: 'Unresolved',
  evDirect: 'Direct passage',
  evCrossRef: 'Cross-reference',
  evStructural: 'Structure',
  evSynthesis: 'Editorial synthesis',
  claimSourceBacked: 'Source-backed',
...
const ml: Record<keyof typeof en, string> = {
  ...
  statusGrounded: 'മൂലാധിഷ്ഠിതം',
  statusGroundedNote: 'താഴെയുള്ള തെളിവുകളിലൂടെ അച്ചടിച്ച മൂലഗ്രന്ഥവുമായി ബന്ധിപ്പിച്ചിരിക്കുന്നു.',
  statusLegacy: 'പദ്ധതിവ്യാഖ്യാനം',
  statusLegacyNote: 'പദ്ധതിവ്യാഖ്യാനത്തിൽനിന്ന് രചിച്ചത്; രാമകണ്ഠനിൽനിന്ന് എടുത്തതല്ല.',
  sourceTermsTitle: 'മൂലപദങ്ങൾ',
  relationshipsTitle: 'ബന്ധങ്ങൾ',
  termAttested: 'തെളിയിക്കപ്പെട്ടത്',
  termNormalised: 'സാമാന്യവൽക്കരിച്ചത്',
  termTranslated: 'പരിഭാഷപ്പെടുത്തിയത്',
  termInferred: 'അനുമാനിച്ചത്',
  relSynonymousWith: 'പര്യായമാണ്',
  relVariantOf: 'രൂപമാണ്',
  relBroaderThan: 'വിശാലമാണ്',
  relNarrowerThan: 'സൂക്ഷ്മമാണ്',
  relPresupposes: 'മുൻകൂട്ടുന്നു',
  relContrastsWith: 'വ്യത്യാസപ്പെടുന്നു',
  relExplains: 'വിശദീകരിക്കുന്നു',
  relQualifiedBy: 'നിയന്ത്രിക്കപ്പെടുന്നു',
  relLeadsTo: 'നയിക്കുന്നു',
  relInseparableFrom: 'വേർപെടുത്താനാവാത്തത്',
  relDistinguishedFrom: 'വേർതിരിച്ചിരിക്കുന്നു',
  relIdentifiedWith: 'ഐക്യപ്പെടുന്നു',
  threadOrientation: 'അവലോകനം',
  threadScholarly: 'ശാസ്ത്രീയം',
  threadTypeConcept: 'ആശയം',
  threadTypeArgument: 'വാദം',
  threadTypeCrossVerse: 'ശ്ലോകാന്തരം',
  threadTypeChapter: 'അദ്ധ്യായം',
  threadTypeDoctrinal: 'സിദ്ധാന്തം',
  threadTypeRecensional: 'പാഠഭേദം',
  roleQuestion: 'ചോദ്യം',
  rolePremise: 'അടിസ്ഥാനം',
  roleObjection: 'ആക്ഷേപം',
  roleResponse: 'പരിഹാരം',
  roleDistinction: 'വിവേചനം',
  roleDefinition: 'നിർവ്വചനം',
  roleExample: 'ഉദാഹരണം',
  roleInference: 'അനുമാനം',
  roleConsequence: 'ഫലം',
  roleConclusion: 'ഉപസംഹാരം',
  roleContext: 'സന്ദർഭം',
  roleUnresolved: 'പരിഹരിക്കാത്തത്',
  evDirect: 'നേരിട്ടുള്ള ഭാഗം',
  evCrossRef: 'പരാമർശം',
  evStructural: 'ഘടന',
  evSynthesis: 'സമ്പാദകീയ സംശ്ലേഷണം',
  claimSourceBacked: 'മൂലാധിഷ്ഠിതം',
