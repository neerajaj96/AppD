...
export const introSections: IntroSection[] = [
  ...
  },
  {
    ...
    body: {
       en: 'Beyond the nine classical schools mapped above, this app carries two Tantric systems: Tantra, the woven scripture that saves by expanding awareness — goddess, serpent power and thousand names — and Kashmir Shaivism, its philosophical centre, holding the Absolute as light that knows itself (prakāśa) inseparably united with power that moves itself (vimarśa); creation is that freedom appearing as thirty-six principles, bondage is forgetting, and practice is recognition (pratyabhijñā) — not becoming someone new but remembering what was never lost. Enter it through the Kashmir Shaivism system: recognition aphorisms, pulsation, the 112 gates of the Vijñānabhairava, and metaphysics — with Kamalakar Mishra\'s Kashmir Shaivism woven into the Kuṇḍalinī (Tantra) and Tantrāloka (Kashmir Shaivism) chapters as their closing synthesis.',
       ml: 'മുകളിലെ ഒമ്പത് ശാഖകൾക്കപ്പുറം ഈ ആപ്പിൽ രണ്ട് താന്ത്രികവ്യവസ്ഥകളുണ്ട്: അവബോധം വികസിപ്പിച്ച് രക്ഷിക്കുന്ന നെയ്ത ശാസ്ത്രമായ തന്ത്രം — ദേവി, സർപ്പശക്തി, സഹസ്രനാമങ്ങൾ — അതിന്റെ ദാർശനികകേന്ദ്രമായ കാശ്മീരശൈവവും. സ്വയം അറിയുന്ന പ്രകാശവും സ്വയം ചലിക്കുന്ന വിമർശവും ചേർന്ന പരമമാണ് അതിലെ സത്യം; സൃഷ്ടി ആ സ്വാതന്ത്ര്യത്തിന്റെ മുപ്പത്തിയാറ് തത്ത്വങ്ങളായുള്ള പ്രത്യക്ഷപ്പെടലും ബന്ധനം മറവിയും സാധന പ്രത്യഭിജ്ഞയുമാണ്. കാശ്മീരശൈവവ്യവസ്ഥയിലൂടെ പ്രവേശിക്കൂ: പ്രത്യഭിജ്ഞാസൂത്രങ്ങൾ, സ്പന്ദനം, വിജ്ഞാനഭൈരവത്തിന്റെ 112 വാതിലുകൾ, തത്ത്വശാസ്ത്രം — കുണ്ഡലിനീ (തന്ത്രം), തന്ത്രാലോക (കാശ്മീരശൈവം) അധ്യായങ്ങളുടെ സമാപന സംശ്ലേഷണമായി മിശ്രയുടെ കാശ്മീരശൈവദർശനത്തോടെ.'
    }
  },
  {
    id: 'mishra-source',
