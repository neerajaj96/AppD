...
export const gitaRamakanthaConcepts: any[] = [
  {
    ...
    relatedVerseIds: ['2.47', '3.3', '5.1', '6.1', '13.26'],
    ...
    occurrences: [
      ...
      { unitId: '13.26', sourceTerm: 'कर्मयोग', spanId: 'gita-seg-13.25-samuccaya', relation: 'commentary', context: 'karma-yoga gloss (samuccayātmakatva as the ārurukṣu stage)', folio: 295, note: 'KSTS 13.25. Action-predominant conjunction still belongs to the one discipline.' },
    ],
    conceptLinks: [
  ...
  },
  {
    ...
    relatedVerseIds: ['13.3', '13.12', '13.13', '13.28', '2.47', '9.1', '10.11'],
    relatedConceptIds: ['gita-rk-prakriti'],
    content: L(
      'Jñāna',
      'Discriminative knowledge of the Self. Rāmakaṇṭha defines it as knowledge of the distinction between field and knower (13.3: kṣetrakṣetrajñayor jñānaṃ matam), treats established Self-knowledge (tattvajñāna-upapatti) as the ground of entitlement to act (2.47), and presents it joined with direct realisation (vijñāna) as liberating (9.1); the lamp of knowledge destroys confusion-born darkness (10.11). In Chapter 13 the virtue aggregate is declared knowledge and its contrary ajñāna (13.12: etaj jñānam iti proktam), while the knowable is approached only as upacāra for the ārurukṣā stage (13.13).',
      'ജ്ഞാനം',
      'ആത്മാവിനെക്കുറിച്ചുള്ള വിവേകജ്ഞാനം. ക്ഷേത്ര-ക്ഷേത്രജ്ഞവിവേകമാണ് ജ്ഞാനം (13.3). തത്ത്വജ്ഞാനത്തിൽ ഉറച്ചവനാണ് കർമ്മത്തിന് അർഹൻ (2.47). സാക്ഷാത്കാരത്തോടുചേർന്ന (വിജ്ഞാനം) ജ്ഞാനം മോചനം നൽകുന്നു (9.1, 10.11). അദ്ധ്യായം 13-ൽ ഗുണസമൂഹം ജ്ഞാനമായും വിപരീതം അജ്ഞാനമായും പ്രഖ്യാപിക്കുന്നു (13.12); ജ്ഞേയം ആരുരുക്ഷാദശയിൽ ഉപചാരം മാത്രമാണ് (13.13).',
    ),
    occurrences: [
      ...
      { unitId: '13.12', sourceTerm: 'ज्ञान', spanId: 'gita-seg-13.11-ajnana', relation: 'commentary', context: 'ajñāna close (anyathā/mānitva as jñāna-viparīta)', folio: 286, note: 'KSTS 13.11 tail, printed p.296. Virtue aggregate declared jñāna, contrary ajñāna.' },
      { unitId: '13.13', sourceTerm: 'ज्ञान', spanId: 'gita-seg-13.12-jneya-resp', relation: 'commentary', context: 'satyam response (jñeya as upacāra for the ārurukṣā stage)', folio: 287, note: 'KSTS 13.12. Jñeya language denied vastava status; jñāna as self-recognition.' },
      { unitId: '13.28', sourceTerm: 'ज्ञान', spanId: 'gita-seg-13.27-samapasya', relation: 'commentary', context: 'jñāna-cakṣuṣ close (vedakaika-lakṣaṇa sākṣātkāra)', folio: 296, note: 'KSTS 13.27. The kindled knowledge-eye sights the lone knower-essence.' },
  ...
  },
  {
    ...
    sourceTerms: [
      ...
      { form: 'समुच्चयात्मकत्व', kind: 'attested', language: 'sa' },
      { form: 'Samuccaya', kind: 'normalised', language: 'sa' },
    ],
    relatedVerseIds: ['2.38', '3.1', '4.1', '7.1', '5.3', '13.26'],
    relatedConceptIds: ['gita-rk-moksa'],
    content: L(
      'Samuccaya',
      'The conjunction of knowledge and action as one teachable content. Rāmakaṇṭha ascertains jñāna-kriyā-samuccaya as what is to be taught (on 2.38), names jñānakarmasamuccaya the abhidheya of the whole prakaraṇa with supreme Self-attainment as prayojana (ch. 4 avataraṇikā), presents Arjuna as asking precisely because he has not ascertained the samuccaya object (ch. 3 avataraṇikā), and describes the samuccaya-practitioner as ever-renounced even while acting (5.3). In Chapter 13 karma-yoga, though conjunction-formed with action predominating, is the ascending (ārurukṣu) stage of the same discipline (13.26: samuccayātmakatva).',
      'സമുച്ചയം',
      'അറിവും പ്രവൃത്തിയും ചേർന്ന സമുച്ചയം ഉപദേശവിഷയമാണ് (2.38). പ്രകരണത്തിന്റെ അഭിധേയവും പരമാത്മസമാപത്തി പ്രയോജനവുമാണ് (അദ്ധ്യായം 4 മുഖവുര). സമുച്ചയാർത്ഥം നിശ്ചയിക്കാത്തതിനാലാണ് അർജ്ജുനൻ ചോദിക്കുന്നത് (അദ്ധ്യായം 3 മുഖവുര). പ്രവർത്തിച്ചുകൊണ്ടും സമുച്ചയാനുഷ്ഠാതാവ് നിത്യസന്നാസിയാണ് (5.3). അദ്ധ്യായം 13-ൽ കർമ്മയോഗം സമുച്ചയാത്മകമായിരുന്നാലും ആരുരുക്ഷുദശയാണ് (13.26).',
    ),
    occurrences: [
      ...
      { unitId: '13.26', sourceTerm: 'समुच्चयात्मकत्व', spanId: 'gita-seg-13.25-samuccaya', relation: 'commentary', context: 'karma-yoga gloss (conjunction-form as the ārurukṣu stage)', folio: 295, note: 'KSTS 13.25, printed p.305. First source-text evidence for the term; the Phase-7 locator-only gap is closed.' },
    ],
    conceptLinks: [
  ...
  },
  {
    ...
    relatedVerseIds: ['13.2', '13.4', '13.6', '13.7', '13.20', '13.27', '13.30', '13.35', '7.4', '7.5'],
    relatedConceptIds: ['gita-rk-purusa'],
    content: L(
      'Prakṛti',
      'The known, objective principle set against the knower. The body is the field (13.2: śarīraṃ kṣetram); the vikāri, the mahābhūtādi aggregate and desire-hatred cohort are field by knowability (13.4, 13.6–13.7); nature is eightfold lower (aparā) with the living (jīva) as higher nature (parā) (7.4–7.5); prakṛti and puruṣa are beginningless in mutual relation (13.20), distinguished as lower (bodily) and higher (jīva) in the closing synthesis (13.35); what the Lord appears as, twofold, through inconceivable māyā-śakti.',
      'പ്രകൃതി',
      'ജ്ഞാതാവിൽനിന്ന് വേർതിരിച്ചറിയേണ്ട ജ്ഞേയവസ്തു. ശരീരം ക്ഷേത്രമാണ് (13.2). വികാരി, മഹാഭൂതാദിസമൂഹം, ഇച്ഛാദ്വേഷാദികൾ എന്നിവ ജ്ഞേയത്വത്താൽ ക്ഷേത്രമാണ് (13.4, 13.6–13.7). അഷ്ടധാ അപരാപ്രകൃതിയും ജീവഭൂതമായ പരാപ്രകൃതിയും (7.4–5). പ്രകൃതിപുരുഷന്മാർ അന്യോന്യസംബന്ധത്തിൽ അനാദികളാണ് (13.20); സമാപനത്തിൽ അപരാപരവിവേകം (13.35).',
    ),
    occurrences: [
      ...
      { unitId: '13.4', sourceTerm: 'क्षेत्र', spanId: 'gita-seg-13.3-gloss', relation: 'commentary', context: 'vikāri gloss (distinctive cause-effect character as field)', folio: 279, note: 'KSTS 13.3. Vikāra/vikāri distinction within the field definition.' },
      { unitId: '13.6', sourceTerm: 'क्षेत्र', spanId: 'gita-seg-13.5-gloss', relation: 'commentary', context: 'kṣetra-saṅgraha gloss (mahābhūtādi aggregate as savikāra kṣetra)', folio: 280, note: 'KSTS 13.5. Twenty-four tattvas as śarīra-bhāva kṣetra.' },
      { unitId: '13.7', sourceTerm: 'क्षेत्र', spanId: 'gita-seg-13.6-iccha', relation: 'commentary', context: 'icchā-ādi gloss (desire-hatred as vedyatvāt kṣetra; saṅghāta/cetanā/dhṛti)', folio: 281, note: 'KSTS 13.6 tail, printed p.291. Darśanāntara categories reduced to kṣetra by knowability.' },
      { unitId: '13.20', sourceTerm: 'प्रकृतिः', spanId: 'gita-seg-13.19-prakrti', relation: 'commentary', context: 'prakṛti-puruṣa recall (saptama viṣaya-bhāva vs śarīra-bhāva)', folio: 291, note: 'KSTS 13.19. Anāditva of the mutual relation, not equal eternity.' },
      { unitId: '13.27', sourceTerm: 'प्रकृति', spanId: 'gita-seg-13.26-samyoga', relation: 'commentary', context: 'kṣetra-saṃyoga gloss (śarīra-bhāva-pariṇatā prakṛti)', folio: 295, note: 'KSTS 13.26. Every birth from the beginningless conjunction through non-discrimination.' },
      { unitId: '13.30', sourceTerm: 'प्रकृति', spanId: 'gita-seg-13.29-prakrtya', relation: 'commentary', context: 'prakṛti-dviprakārā gloss (twofold nature as jagat-citra cause)', folio: 297, note: 'KSTS 13.29. Field-knower conjunction figures the whole world-picture.' },
      { unitId: '13.35', sourceTerm: 'प्रकृति', spanId: 'gita-seg-13.34-synthesis', relation: 'commentary', context: 'antara gloss (aparā bodily vs parā jīva nature distinction)', folio: 301, note: 'KSTS 13.34. Closing synthesis object of viduḥ.' },
  ...
  },
  {
    ...
    relatedVerseIds: ['13.3', '13.20', '13.22', '13.23', '13.24', '15.16', '15.17', '15.18'],
    relatedConceptIds: [],
    content: L(
      'Puruṣa',
      'The conscious principle: the single percipient present in all fields, argued from the distinction between manifold known bodies and unfailing knowership (13.3); recalled with prakṛti as beginningless correlates (13.20: anyonyasambaddhatvena anādī), and as maheśvara dwelling as witness-permitter-bearer-enjoyer through self-māyā reference (13.23); discriminated as perishable and imperishable (15.16), with the supreme person beyond both (15.17–18: puruṣottama).',
      'പുരുഷൻ',
      'ചേതനതത്ത്വം — എല്ലാ ക്ഷേത്രങ്ങളിലുമുള്ള ഏക വേദകൻ (13.3). പ്രകൃതിയോടൊത്ത് അനാദിസംബന്ധത്തിൽ (13.20); സ്വമായാമുഖേന ഉപദ്രഷ്ടാവായി (13.23). ക്ഷരാക്ഷരവിവേകം; ഇവയ്ക്കതീതനായ ഉത്തമപുരുഷൻ (15.16–18).',
    ),
    occurrences: [
      ...
      { unitId: '13.20', sourceTerm: 'पुरुषः', spanId: 'gita-seg-13.19-prakrti', relation: 'commentary', context: 'prakṛti-puruṣa recall (viṣayitvena/śarīritvena pratipādita)', folio: 291, note: 'KSTS 13.19. Puruṣa as correlate of prakṛti in anādi relation.' },
      { unitId: '13.22', sourceTerm: 'पुरुषः', spanId: 'gita-seg-13.21-gunasanga-a', relation: 'commentary', context: 'prakṛti-stha gloss (māyāvaśāt abiding; bhuṅkte by knowership)', folio: 292, note: 'KSTS 13.21. Spirit subjectifies nature-born guṇas.' },
      { unitId: '13.23', sourceTerm: 'पुरुष', spanId: 'gita-seg-13.22-mahesvara', relation: 'commentary', context: 'maheśvara gloss (sarvapuruṣaiśvarya; svamāyodbhāvita vyapadeśa)', folio: 293, note: 'KSTS 13.22 tail, printed p.293. Puruṣa as upadraṣṭā etc. by māyā reference, paramātman on viveka.' },
      { unitId: '13.24', sourceTerm: 'पुरुषं', spanId: 'gita-seg-13.23-yogi', relation: 'commentary', context: 'yaḥ-yogī gloss (nānākṣetrajña-rūpatayā known with the guṇas)', folio: 293, note: 'KSTS 13.23. The triad-knower in every station is not reborn.' },
  ...
  },
  {
    ...
    relatedVerseIds: ['7.14', '13.3', '13.22', '13.23', '13.30', '18.61'],
    relatedConceptIds: [],
    content: L(
      'Māyā',
      'The Lord\u2019s own power (madīyā śakti), sportive in nature (devanāt/krīḍanāt) and hard to cross (duratyayā), unreal yet appearing real (7.14); the inconceivable Īśvara-māyā-śakti whose play differentiates experience (13.3); the self-māyā reference through which the lord appears as witness etc. in the body (13.23: svamāyodbhāvita); the machine-power through which Īśvara moves beings (18.61–62). Crossed not by flight but by resort (prapatti) through knowledge ending in non-difference (7.14).',
      'മായ',
      'ഭഗവാന്റെ സ്വന്തം ശക്തി — ലീലാസ്വഭാവവും കടക്കാൻ പ്രയാസവുമുള്ളത്, അസത്യമായിട്ടും സത്യമായി തോന്നുന്നത് (7.14). അചിന്ത്യമായ ഈശ്വരമായാശക്തിയുടെ വിലാസമാണ് ഭേദാനുഭവം (13.3). സ്വമായാമുഖേന ദേഹത്തിൽ സാക്ഷിയായി (13.23). ശരണം-ജ്ഞാനത്താൽ മായ കടക്കാം.',
    ),
    occurrences: [
      ...
      { unitId: '13.22', sourceTerm: 'माया', spanId: 'gita-seg-13.21-gunasanga-a', relation: 'commentary', context: 'prakṛti-stha gloss (māyāvaśāt abiding in transformed nature)', folio: 292, note: 'KSTS 13.21. Māyā as the medium of the avivekaja contact.' },
      { unitId: '13.30', sourceTerm: 'माया', spanId: 'gita-seg-13.29-akartra', relation: 'commentary', context: 'akartṛ close (difference as māyāmātra-vilasita)', folio: 297, note: 'KSTS 13.29. Doer-talk rests on difference, and difference on māyā alone.' },
      { unitId: '13.23', sourceTerm: 'माया', spanId: 'gita-seg-13.22-mahesvara', relation: 'commentary', context: 'maheśvara gloss (svamāyodbhāvita-puruṣa-vyapadeśa)', folio: 293, note: 'KSTS 13.22 tail, printed p.293. Māyā as the reference through which witnesshood is stated.' },
  ...
  },
  {
    ...
    sourceTerms: [
      ...
      { form: 'भूतप्रकृतिमोक्ष', kind: 'attested', language: 'sa' },
      { form: 'अपवर्ग', kind: 'attested', language: 'sa' },
      { form: 'अपवर्गमार्ग', kind: 'attested', language: 'sa' },
      { form: 'Mokṣa', kind: 'normalised', language: 'sa' },
    ],
    relatedVerseIds: ['1.1', '7.14', '9.33', '9.1', '13.35'],
    relatedConceptIds: [],
    content: L(
      'Mokṣa',
      'Release, termed apavarga as the highest human end (upodghāta: apavargasya parapuruṣārthatvāt). When uncrossable māyā seems to make teaching vain, the answer is resort through knowledge (7.14); seers participate in release (apavarga-bhāgitva) through Self-knowledge and devotion (9.33); liberating knowledge releases (9.1: mokṣyase). In Chapter 13 release from gross (bhūta) nature is distinguished from mere distinction-cognition, grounded in abiding in the distinct self-essence (13.35: bhūtaprakṛtimokṣa).',
      'മോക്ഷം',
      'പരമപുരുഷാർത്ഥമായ അപവർഗം — മോചനം (ഉപോദ്ഘാതം). മായ കടക്കാനാവാത്തതിനാൽ ഉപദേശം വ്യർത്ഥമെന്ന ശങ്കയ്ക്ക് ശരണം-ജ്ഞാനമാണ് മറുപടി (7.14). ആത്മജ്ഞാനത്താലും ഭക്തിയാലും അപവർഗഭാഗിത്വം (9.33). ജ്ഞാനത്താൽ മോചനം (9.1). അദ്ധ്യായം 13-ൽ സ്ഥൂലപ്രകൃതിയിൽനിന്നുള്ള മോക്ഷം വിവേകമാത്രത്തിൽനിന്ന് വേർതിരിക്കുന്നു (13.35: ഭൂതപ്രകൃതിമോക്ഷം).',
    ),
    occurrences: [
      ...
      { unitId: '13.35', sourceTerm: 'भूतप्रकृतिमोक्ष', spanId: 'gita-seg-13.34-moksa', relation: 'commentary', context: 'bhūtaprakṛtimokṣa exposition (release beyond mere viveka, by nityāvahitatva)', folio: 301, note: 'KSTS 13.34, printed p.311. First source-text evidence for the term; the Phase-7 locator-only gap is closed.' },
    ],
    conceptLinks: [],
  },
];
