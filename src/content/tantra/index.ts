...
// Trika means) → recognition metaphysics (Tantrāloka). All five
...
export const tantraSystem: System = {
  ...
  texts: [deviMahatmyaText, kundaliniTantraText, lalitaSahasranamaText, shivaSutrasText, tantralokaText],
  thread: [...deviMahatmyaThread, ...kundaliniTantraThread, ...lalitaSahasranamaThread, ...shivaSutrasThread, ...tantralokaThread],
};
